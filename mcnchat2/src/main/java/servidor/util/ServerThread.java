...
//SERVERTHREAD OBJECT EXTENDS THREAD
public class ServerThread extends Thread {
    ...
    //MESSAGE PRE-PROCCESSING METHOD
    private void checkMsg(String msg) throws SQLException {
            ...
            try {
                ...
                if(amigos.size() != 0) {
                    for(int i=0; i<size; i++) {
                        Usuario temp = amigos.get(i); //STORES THE USER AT POSITION X
        ...
        //COMMAND REQUESTFRIENDCONNECTION
